...
# Optional filter: only load data for these 3 regions
predicate_pushdown = "region in ('ca','gb','us')"

# Load data from Glue Data Catalog table
...
# Apply column mappings (schema transformation)
...
# Resolve ambiguities and drop nulls
...
# Convert DynamicFrame to DataFrame and coalesce to 1 file
